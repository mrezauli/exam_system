        ...
        <div class="col-sm-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    {{-- ------------ Filter :Starts ---------------------------------------- --}}
                    {!! Form::open(['method' => 'GET', 'route' => 'generate-short-typing-test-report', 'class' => 'report-form']) !!}
                    <div class="col-sm-12">
                    ...
                    @if (isset($model) && !$model->isEmpty())
                        <div class="col-lg-12 col-md-3 col-sm-6 all-graph-pdf-report-block">
                            ...
                            <a href="#" class="btn btn-danger print-button-wr pull-right">Print Result without
                                Remarks</a>
