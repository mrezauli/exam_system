...
?>
    ...
    <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
        <div class="row">
            <div class="col-sm-6">
                ...
                {!! Form::text('company_name', Input::old('company_name'), ['id'=>'company_name', 'class' => 'form-control','required', 'style'=>'text-transform:capitalize','company_name'=>'enter company name, example :: Main company',$disables]) !!}
            </div>
            <div class="col-sm-6">
    ...
    <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
        <div class="row">
            ...
            <div class="col-sm-6">
                {!! Form::label('email', 'E-Mail :', ['class' => 'control-label']) !!}  <span class="write-in-english" style="color:#FF0000">(ইংরেজিতে লিখুন)</span>
    ...
    <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
        <div class="row">
            <div class="col-sm-6 edit-company-input-group">
    ...
    <div class="form-margin-btn">
        <a href="{{route('company')}}" class=" btn btn-default" data-placement="top" data-content="click close button for close this entry form" onclick="close_modal();">Close</a>
