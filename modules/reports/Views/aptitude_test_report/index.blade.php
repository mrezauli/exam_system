            ...
            <div class="col-sm-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open([
                            'method' => 'GET',
                            'route' => ['generate-aptitude-test-report', $roll_wise],
                            'class' => 'report-form',
                        ]) !!}
                        <div class="col-sm-12">
                        ...
                        <div class="pull-left pdf-report-button">
                            ...
                            <a href="#" class="btn btn-danger print-button pdf_report_button">Print Result with
                                Remarks</a>

                            <a href="#" class="btn btn-danger print-button-wr pdf_report_button">Print Result without
                                Remarks</a>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @if (isset($group['word']))
                                        <th style="border-left: 1.7px solid #8189fd !important;border-right: 1.7px solid #8189fd !important;"
                                            colspan="{{ $word_question_no }}">MS Word</th>
                                    @endif


                                    @if (isset($group['excel']))
                                        <th style="border-right: 1.7px solid #8189fd !important;"
                                            colspan="{{ $excel_question_no }}">MS Excel</th>
                                    @endif
                                ...
                                <tr>
                                    ...
                                    @if (isset($group['excel']))
                                        ...
                                        @foreach ($group['excel'] as $excel_question)
                                            ...
                                            <th style="border-right:1.7px solid #8189fd !important;">Question
                                                {{ $k }} ( {{ $question_mark }} )</th>
                                        @endforeach
                            ...
                            <tbody>
                                ...
                                @if ($status == 2)
                                    ...
                                    @foreach ($model as $values)
                                        ...
                                        $exam_code_id = $values
                                            ->groupBy('exam_code_id')
                                            ->keys()
                                            ->first();
                                        
                                        $all_group = !empty($exam_code_id)
                                            ? $header_all
                                                ->groupBy('exam_code_id')
                                                ->get($exam_code_id)
        ...
        <div class="table-primary print-report-table-wr-wrapper">
            ...
            <div class="print-section print-show">
                <div class="header-section">
                    ...
                    <p class="header">{{ isset($header->address_three) ? $header->address_three : '' }}</p>
                    <p class="header">{{ isset($header->address_four) ? $header->address_four : '' }}</p>
                    <p class="header">পদের নাম: {{ isset($header->designation_name) ? $header->designation_name : '' }}
                    </p>
                    <p class="header">পরীক্ষার তারিখ: {{ $exam_dates_string }}</p>
                    <p class="header">পরীক্ষা গ্রহণে: বাংলাদেশ কম্পিউটার কাউন্সিল।</p>
                </div>
