<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            {!! Form::select('exam_type', array(''=>'Select exam type','bangla'=>'Bangla', 'english'=>'English'),Input::old('exam_type'),['class' => 'form-control','title'=>'select exam type','required']) !!}
        </div>
...
<div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t">
    <div class="row">
        <div class="col-sm-offset-1 col-sm-12">
            ...
            {!! Form::textarea('typing_question[]', Input::old('typing_question'), ['id'=>'typing_question', 'class' => 'typing_question form-control','size' => '12x18','title'=>'Please Insert Typing Text']) !!}
            <button type="button" id="addnew" class="btn btn-primary btn-sm add-button add-typing-test-button"><font>+</font></button>
        </div>
    </div>
</div>
