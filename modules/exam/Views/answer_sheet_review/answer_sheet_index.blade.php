        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <a href="{{route('answer-sheet-review')}}" class="btn btn-default pull-right" data-placement="top" data-content="click close button for close this entry form">Back</a>
                </header>
                ...
                {!! Form::open(['route' => 'store-review-marks','id' => 'jq-validation-form']) !!}
                    ...
                    @foreach($answer_html_files as $ques_values)
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="color: blue; background-color:silver">
                                ...
                                <span><b>&nbsp;Question Mark :: &nbsp; {{$ques_values['question_mark']}}</b></span>&nbsp;&nbsp;&nbsp;
                                @if(1)
                                <tr>
                                    <td>
...
<div class="clearfix"></div>
                    ...
                    <div class="col-sm-12">
                        {!! Form::label('aptitude_exam_review_comments', 'Comments:', ['class' => 'control-label']) !!}
                        {!! Form::textarea('aptitude_exam_review_comments', $data->aptitude_exam_review_comments, ['id'=>'aptitude_exam_review_comments', 'class' =>'aptitude_exam_review_comments', 'style' =>'width:100%', 'size' => '12x5']) !!}
                    </div>
                ...
                @if($data !=null)
                    <div class="col-sm-12">{!! Form::submit('Submit Marks', ['class' => 'btn btn-primary pull-right','data-placement'=>'top']) !!}</div>
                @endif
