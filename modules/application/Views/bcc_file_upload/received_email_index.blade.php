                            ...
                            @foreach($data as $values)
                                <tr class="gradeX">
                                    ...
                                    ?>
                                        ...
                                        <a href="{{ route('view-organization-' . $application_format,['received', $values->id]) }}" class="btn btn-info btn-xs" data-placement="top" data-content="view"><i class="fa fa-eye"></i></a>
