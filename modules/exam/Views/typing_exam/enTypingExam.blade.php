...
<div class="form-block">
    ...
    <div class="form-group image no-margin-hr panel-padding-h no-padding-t no-border-t navbar-fixed-top">
        <div class="row">
    ...
    @if (($first_exam_started && !$first_exam_completed) || ($last_exam_started && !$last_exam_completed))
        ...
        <div class="question-answer-block">
            ...
            {!! Form::open([
                'route' => ['submit-typing-exam-en-preview', $exam_type],
