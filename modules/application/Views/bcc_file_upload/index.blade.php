        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    {{ $pageTitle }}
                    <a class="btn-sm btn-success pull-right paste-blue-button-bg" href="{{route('create-bcc-file-upload')}}">
                        <b>Create Letter</b>
                    </a>
                </header>
                <br>
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('view-bcc-' . $application_format, ['null', $values->id]) }}" class="btn btn-info btn-xs" data-placement="top" data-content="view"><i class="fa fa-eye"></i></a>
                                        {{-- <a href="{{ route('edit-bcc-' . $application_format, $values->id) }}" class="btn btn-primary btn-xs edit-link"><i class="fa fa-edit"></i></a> --}}
                                    </td>
                                </tr>
                                @endforeach
                                @endif
