...
<div class="question-answer-block">
  ...
  {!! Form::open(['route' => ['submit-typing-exam-bn-preview',$exam_type],'id' => 'jq-validation-form','class' => 'exam-form']) !!}
...
<div class="row">
  <div class="text-right">
      {!! Form::submit('Submit Bangla', ['class' => 'btn btn-primary submit-button typing-exam-submit-button btn-sm','data-placement'=>'top']) !!}
  </div>
</div>
