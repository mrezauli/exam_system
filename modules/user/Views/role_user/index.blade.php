            ...
            <div class="panel-body">
                ...
                <div id="index-search">
                    ...
                    <div class="filter-btn">
                        {!! Form::submit('Search', array('class'=>'btn btn-info btn-xs btn-search-height','id'=>'button', 'data-placement'=>'right', 'data-content'=>'type username or select role or both in specific field then click search button for required information')) !!}
                    </div>
                </div>
                {!! Form::close() !!}
                <p> &nbsp;</p>
