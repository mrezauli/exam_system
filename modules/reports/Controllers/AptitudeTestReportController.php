...
// dd($bangla_speed);
        ...
        $header = DB::table( 'qselection_aptitude_test AS q' )
                    ->select('q.id as qselection_aptitude_id','e.company_id','e.designation_id','e.exam_date','q.question_type','q.shift','qa.question_mark','q.exam_code_id','q.question_set_id','q.qbank_aptitude_id','c.company_name','c.address_one','c.address_two','c.address_three','c.address_four','d.designation_name')
