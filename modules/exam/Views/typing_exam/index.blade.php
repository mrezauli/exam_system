    ...
    <div class="col-sm-12">
        ...
        <div class="clearfix"></div>
            ...
            <table style="max-width:1200px;margin:0 auto;" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr style="font-size: 22px!important;"><td><b>&nbsp; ৪.    নির্ধারিত টেক্সট এরিয়া ফিল্ড সিলেক্ট করে ইংরেজী টাইপ শুরু করুন। ইংরেজী টাইপ শেষ হলে “Submit” বাটনে ক্লিক করুন। </b></td></tr>
                <tr style="font-size: 22px!important;"><td><b>&nbsp; ৫.    এরপর বাংলা টাইপ এর জন্য বিজয় / অভ্র কীবোর্ড নির্বাচন করুন। ইউনিকোড টাইপের জন্য প্রয়োজনীয় কীবোর্ড সেটিংস পরিবর্তন করুন। নির্ধারিত টেক্সট এরিয়া ফিল্ড সিলেক্ট করে বাংলা টাইপ শুরু করুন। </b></td></tr>
...
function alert_message() {
  ...
  if (! typing_test_alerted) {
    ...
    Cookies.set('typing_test_alerted',1,{ expires: 1 });
