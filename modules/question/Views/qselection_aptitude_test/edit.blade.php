    ...
    <a href="{{route('qselection-aptitude-test')}}" class=" btn btn-default pull-right" data-placement="top" data-content="click close button for close this entry form">Back</a>
            ...
            <div class="panel-body">
                <div class="adv-table">
                    ...
                    {!! Form::model($data, ['method' => 'PATCH', 'route'=> ['update-qselection-aptitude-test', $data->id],'class'=>'qselection-aptitude-test-form']) !!}
                    ...
                    <table  class="display table table-bordered table-striped typing-select-table" id="example">
                       ...
                       {{--  $jobarea = Modules\Admin\JobArea::find($values->job_area_id);
                            $area_name = $jobarea->area_name;  --}}
                                <tr class="gradeX">
                                    <td><input type="radio" name="question_set_id" class="btn radio" {{($values->id == $selected_questions_id)?'checked':''}} data-id="{{$values->id}}" value="{{$values->id}}"></td>
...
// $('.qselection-aptitude-test-form').submit(function(e) {
//     e.preventDefault();

//     $('.qselection-aptitude-test-form input,.qselection-aptitude-test-form select').removeAttr('disabled');

//     $('.qselection-aptitude-test-form input,.qselection-aptitude-test-form select').attr('readonly','readonly');
