                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-lg-25 col-md-3 col-sm-6">
                            ...
                            {!! Form::text('from_date', Input::get('from_date') ? Input::get('from_date') : null, [
                                'id' => 'from_date',
                        ...
                        <div class="col-lg-25 col-md-3 col-sm-6">
                            ...
                            <small class="required jrequired">(Required)</small>
                            {!! Form::text('to_date', Input::get('to_date') ? Input::get('to_date') : null, [
                                'id' => 'to_date',
                                'class' => 'form-control datepicker',
                                'required' => 'required',
                            ]) !!}
                    ...
                    <div class="table-primary report-table-wrapper">
                        ...
                        <table style="margin:30px auto;width:30%;" cellspacing="1" border="1"
