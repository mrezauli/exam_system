...
class ShortAptitudeTestReportController extends Controller
{
    ...
    public function aptitude_test_report(){
        ...
        $header = $passed_count = $failed_count = $remarks = '';
    ...
    if ($exam_code != ''){
        ...
        // $question_marks = collect($question_marks->get())->groupBy('shift')->first();
...
// dd($total_question_marks);
    ...
    public function aptitude_test_details($bangla_exam_id,$english_exam_id){
        ...
        return view('reports::short_aptitude_test_report.aptitude_test_details', compact('page_title','bangla_text','english_text'));
