...
class UserTableCreate extends Migration
{
    ...
    public function up()
    {
        ...
        schema::create('user', function (Blueprint $table) {
            ...
            $table->enum('started_exam',array('typing_test','aptitude_test'))->nullable();
        ...
        Schema::table('user', function($table) {
            ...
            if(Schema::hasTable('role') && Schema::hasTable('department') && Schema::hasTable('company') && Schema::hasTable('designation'))
            {
                $table->foreign('role_id')->references('id')->on('role');
                $table->foreign('department_id')->references('id')->on('department');
                $table->foreign('company_id')->references('id')->on('company');
                $table->foreign('designation_id')->references('id')->on('designation');
                $table->foreign('typing_exam_code_id')->references('id')->on('exam_code');
                $table->foreign('aptitude_exam_code_id')->references('id')->on('exam_code');
                $table->foreign('mcq_exam_code_id')->references('id')->on('exam_code');
            }
        });
